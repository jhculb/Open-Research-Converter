...
class Header extends Component {
    render() {
        return <>
            <div className="col-2">
                <img className="mt-2 justify-content-center img-header" src={gesis_logo} alt="gesis" onClick={()=>window.open(this.props.href, "_self")}/>
            </div>
            <h1 className="col-10 mt-2 d-flex justify-content-center title-color">
                {this.props.title}
            </h1>
