...
class Header extends Component {
    render() {
        return <>
            ...
            <div className="col-12 col-md-8 mt-2 d-flex justify-content-center justify-content-md-center">
                <h1 className="title-color text-center mr-md-75">
                    {this.props.title}
                </h1>
            </div>
            <div className="col-12 col-md-2 mt-2 d-flex justify-content-center justify-content-md-end align-self-end">
                {
                    this.props.isHome ?
                        <a data-testid="is-home" href="/about" className="mb-0 link-color button-font">
                            About
                        </a>
                        :
                        <a data-testid="is-not-home" href="/" className="mb-0 link-color button-font">
                            Home
